...
- 自动将 `infra/compose/.env` 设为本地默认值：
  - `CLAWLOOPS_DOMAIN=clawloops.192.168.0.96.nip.io`
  - `RUNTIME_MANAGER_DOMAIN=runtime-manager.clawloops.192.168.0.96.nip.io`
...
4. 启动后默认访问地址是 `http://clawloops.192.168.0.96.nip.io`
5. Runtime Manager 默认访问地址是 `http://runtime-manager.clawloops.192.168.0.96.nip.io`
